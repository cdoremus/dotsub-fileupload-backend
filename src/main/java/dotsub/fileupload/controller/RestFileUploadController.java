...
public class RestFileUploadController {
	...
	public ResponseEntity handleUpload(@RequestParam("uploadedFile") MultipartFile uploadedFile) {
	...
	public ResponseEntity<Map<String, Object>> handleFileUploadMetatadataRepositoryException(
			FileUploadMetatadataRepositoryException e) {
	...
	// public String handleUpload(@RequestParam("uploadedFile") MultipartFile
	// uploadedFileRef) {
